  ...
  return (
    ...
    >
      ...
      <div className='bg-[#F9FAFB] py-3 px-5'>
        ...
        <span className='text-[#262626] text-sm font-medium font-inter float-end mr-3'>Registered Date</span>
      </div>


      
      <div className='flex px-5 py-3 border-b-[1px] border-b-[#EAECF0]'>
        <div className='mt-2'>
